...
A from-scratch, GitOps-managed observability platform on AWS EKS — metrics, logs,
traces, SLOs, error budgets, burn-rate alerting, and chaos engineering — built
around a real sample application.
...
| 8 | Burn-rate alerts — Alertmanager → Slack | ⬜ todo | `alerts/` |
...
> endpoint CIDR as a `203.0.113.0/24` placeholder — **replace it** before applying.
